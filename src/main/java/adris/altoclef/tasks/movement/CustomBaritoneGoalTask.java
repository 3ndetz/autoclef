        ...
        if (_wander) {
            ...
            if (isFinished(mod)) {
                ...
                if (_wanderTask.isActive() && !_wanderTask.isFinished(mod)) {
                    ...
                    setDebugState("Исследование..."); //"Wandering..
                    _checker.reset();
                    return _wanderTask;
                }
                ...
                //Debug.logMessage("чооо вандер ");
                //return _unstuckTask;
            }
        }
        //// ПОТЕНЦИАЛЬНО БАГОВОЕ МЕСТО BARTINE BUG PLACE !!!!!!! !! ! !!!!
        ////
        /*Debug.logMessage("getCustomGoalProcess().isActive()="
                +mod.getClientBaritone().getCustomGoalProcess().isActive()
                +" getGoal="+mod.getClientBaritone().getCustomGoalProcess().getGoal()+" isPathing="+mod.getClientBaritone().getPathingBehavior().isPathing());*/
        if (!mod.getClientBaritone().getCustomGoalProcess().isActive()) {
            //Debug.logMessage("чооо ");
