...
public class ItemHelper {
    ...
    public static ItemStack getHandItem(AltoClef mod){
        if (AltoClef.inGame() && mod.getPlayer()!=null && mod.getPlayer().getItemsHand()!=null) {
            for (ItemStack item : mod.getPlayer().getItemsHand()){
    ...
    public static final Item[] TERRACOTTA = new Item[]{Items.RED_TERRACOTTA, Items.RED_GLAZED_TERRACOTTA,Items.WHITE_TERRACOTTA, Items.WHITE_GLAZED_TERRACOTTA,Items.BLACK_TERRACOTTA, Items.BLACK_GLAZED_TERRACOTTA,Items.BLUE_TERRACOTTA, Items.BLUE_GLAZED_TERRACOTTA,Items.BROWN_TERRACOTTA, Items.BROWN_GLAZED_TERRACOTTA,Items.CYAN_TERRACOTTA, Items.CYAN_GLAZED_TERRACOTTA,Items.GRAY_TERRACOTTA, Items.GRAY_GLAZED_TERRACOTTA,Items.GREEN_TERRACOTTA, Items.GREEN_GLAZED_TERRACOTTA,Items.LIGHT_BLUE_TERRACOTTA, Items.LIGHT_BLUE_GLAZED_TERRACOTTA, Items.LIGHT_GRAY_TERRACOTTA,Items.LIME_TERRACOTTA, Items.LIME_GLAZED_TERRACOTTA,Items.MAGENTA_TERRACOTTA, Items.MAGENTA_GLAZED_TERRACOTTA,Items.ORANGE_TERRACOTTA, Items.ORANGE_GLAZED_TERRACOTTA,Items.PINK_TERRACOTTA, Items.PINK_GLAZED_TERRACOTTA,Items.PURPLE_TERRACOTTA, Items.PURPLE_GLAZED_TERRACOTTA,Items.RED_TERRACOTTA, Items.RED_GLAZED_TERRACOTTA, Items.RED_CONCRETE,Items.YELLOW_TERRACOTTA, Items.YELLOW_GLAZED_TERRACOTTA};
    public static final Item[] CONCRETE = new Item[]{Items.RED_CONCRETE,Items.WHITE_CONCRETE,Items.BLACK_CONCRETE, Items.BLUE_CONCRETE, Items.BROWN_CONCRETE,Items.CYAN_CONCRETE,  Items.GRAY_CONCRETE, Items.GREEN_CONCRETE, Items.LIGHT_BLUE_CONCRETE, Items.LIGHT_GRAY_CONCRETE,Items.LIME_CONCRETE,Items.MAGENTA_CONCRETE, Items.ORANGE_CONCRETE,Items.PINK_CONCRETE, Items.PURPLE_CONCRETE, Items.RED_CONCRETE, Items.RED_CONCRETE,Items.YELLOW_CONCRETE};
    ...
    public static final Item[] CHAINMAIL_ARMORS = new Item[]{Items.CHAINMAIL_CHESTPLATE, Items.CHAINMAIL_LEGGINGS, Items.CHAINMAIL_HELMET, Items.CHAINMAIL_BOOTS};
    ...
    public static final Item[] HelmetsTopPriority = new Item[] {Items.NETHERITE_HELMET, Items.DIAMOND_HELMET, Items.IRON_HELMET, Items.CHAINMAIL_HELMET, Items.GOLDEN_HELMET, Items.LEATHER_HELMET};
