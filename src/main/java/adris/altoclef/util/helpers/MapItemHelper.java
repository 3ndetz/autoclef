...
//            MapState mapState = FilledMapItem.getMapState(stack, mod.getWorld());
//            if (mapState != null){
//                String saveResult = saveMapFile(mod, mapIdComponent,mapState, neural_solve);
...
//        }
    ...
    public static String saveMapFile(AltoClef mod, MapIdComponent mapId, MapState mapState, boolean neural_solve){
