...
public abstract class MouseMoveHelper {
    ...
    public static void windMouse(int start_x, int start_y, int dest_x, int dest_y, double G_0, double W_0, double M_0, double D_0) {
        /*
        ...
        while (dist >= 1) {
            ...
            if (current_x != move_x || current_y != move_y) {
                ...
                //move_mouse.moveMouse(current_x = move_x, current_y = move_y);
            }
